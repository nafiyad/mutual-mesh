...
const seedScenario: ScenarioState = {
  ...
  contributions: [
    ...
    {
      id: 'contribution-backup-display', participantId: 'participant-priya', kind: 'resource', capability: 'presentation-av',
  ...
  plan: {
    ...
    tasks: [
      { id: 'task-venue', key: 'venue', label: 'Venue', requiredCapability: 'accessible-venue', startsAt: SETUP, endsAt: END, capacityRequired: 50, contributionIds: ['contribution-venue'], dependencyTaskIds: [], status: 'suggested' },
      ...
      { id: 'task-poster', key: 'poster', label: 'Event poster', requiredCapability: 'event-promotion', startsAt: '2026-09-08T09:00:00-06:00', endsAt: '2026-09-09T06:00:00-06:00', contributionIds: ['contribution-poster'], dependencyTaskIds: [], status: 'suggested' },
      { id: 'task-host', key: 'host', label: 'Host and access check', requiredCapability: 'event-hosting', startsAt: SETUP, endsAt: END, contributionIds: ['contribution-host'], dependencyTaskIds: ['task-venue'], status: 'suggested' },
